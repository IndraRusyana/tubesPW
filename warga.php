...
<?php include 'header.php'; ?>
  ...
  <div class="row">
    <div class="col-10 my-4 mx-auto">
      <p>Distribusi Zakat Fitrah / Data Warga</p>
    </div>
  </div>

  <div class="">
    <div class="col-10 shadow-sm p-3 mb-5 bg-white rounded mx-auto">
      <h3>Data Distribusi Warga</h3>
      <table class="table">
        <thead>
          <tr>
            <th scope="col">No</th>
        ...
        <tbody>
          <?php
          if (count($mustahikwarga) == 0) { ?>
            <tr>
              <td>Tidak ada data...</td>
            </tr>
          <?php } ?>
          <?php $count = 1; ?>
          <?php foreach ($mustahikwarga as $key) : ?>
            <tr>
  ...
  <div class="modal fade" id="tambahModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header bg-dark">
          <h5 class="modal-title text-white" id="exampleModalLabel">Tambah Data Mustahik</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span class="text-white" aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body text-center" id="modal_body">
          <form action="" method="post">
            ...
            <div class="modal-footer">
              <button class="btn btn-info" type="submit" name="addmustahikwarga">Tambah Data</button>
              <button type="button" class="btn btn-secondary" data-dismiss="modal">Kembali</button>
            </div>
          </form>
        </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body text-center" id="modal_body">
            <form action="" method="post">
              ...
              <div class="modal-footer">
                <button class="btn btn-info" type="submit" name="editmustahikwarga">Simpan</button>
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Kembali</button>
              </div>
            </form>
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <form action="" method="post">
              <input type="hidden" name="id" id="" value="<?= $key['id'] ?>">
              <button class="btn btn-danger" type="submit" name="deletemustahikwarga">Konfirmasi</button>
              <button type="button" class="btn btn-secondary" data-dismiss="modal">Kembali</button>
            </form>
          </div>
        </div>
